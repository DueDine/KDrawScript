...
namespace KDrawScript.Dev
{
    ...
    public class Yuweyawata
    {
        ...
        {
            accessory.Method.TextInfo("Spread", duration: 2000, true);
        }
        ...
        {
            accessory.Method.TextInfo("AOE & Kill Adds", duration: 2000, true);
        }
        ...
        {
            accessory.Method.TextInfo("Big AOE", duration: 2000, true);
        }
        ...
        public void CaberToss(Event @event, ScriptAccessory accessory)
        {
            ...
            {
                accessory.Method.TextInfo("To SW", duration: 2000, true);
            }
            if (@event["Index"] == "0000000E")
            {
                accessory.Method.TextInfo("To NW", duration: 2000, true);
            }
        }
        ...
        {
            accessory.Method.TextInfo("Tank Buster", duration: 1500, true);
        }
        ...
        {
            accessory.Method.TextInfo("Donut", duration: 2000, true);
        }
        ...
        {
            accessory.Method.TextInfo("Misdirection", duration: 2000, true);
        }
        ...
        {
            accessory.Method.TextInfo("Group Stack", duration: 2000, true);
        }
        ...
        public void RagingClaw(Event @event, ScriptAccessory accessory)
        {
            ...
            accessory.Method.TextInfo("Behind the boss", duration: 2000, true);
        }
        ...
        public void CraterCarve(Event @event, ScriptAccessory accessory)
        {
            ...
            accessory.Method.SendDraw(DrawModeEnum.Default, DrawTypeEnum.Circle, dp);
            accessory.Method.TextInfo("Chariot", duration: 2000, true);
        }
